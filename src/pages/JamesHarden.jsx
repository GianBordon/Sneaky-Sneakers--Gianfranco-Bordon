...
const JamesHarden = () => {
  const achievements = [
    ...
    "1 vez Máximo asistidor de la NBA (2017)",
    "1 vez Líder en eficiencia de la NBA (PER) (2018)",
    "3 veces Líder en triples anotados de la NBA (2018, 2019, 2020)",
    "10 veces Elegido para el All-Star de la NBA (2013, 2014, 2015, 2016, 2017, 2018, 2019, 2020, 2021, 2022)",
    "6 veces Mejor Equipo de la NBA (2014, 2015, 2017, 2018, 2019, 2020)",
    "1 vez Tercer Mejor Equipo de la NBA (2013)",
    "1 vez Segundo Equipo de Novatos de la NBA (2010)",
    "1 vez Mejor Sexto Hombre de la NBA (2012)"
  ];
  ...
  return (
    <>
      ...
      {/* Player Banner */}
      <section className="bg-gradient-to-r from-red-600 to-black text-white py-16 text-center">
        <h1 className="text-5xl font-bold">James Harden</h1>
      </section>

      {/* Player Title */}
      <section className="py-8">
        <div className="container mx-auto px-4">
          <h2 className="text-3xl font-bold text-center">James Harden</h2>
        </div>
      </section>
      ...
      <section className="py-8">
        <div className="container mx-auto px-4">
          <div className="flex justify-center">
            <img 
              src="/src/assets/img/Harden/hardem.webp" 
              alt="foto_perfil_james_harden"
      ...
      <section className="py-8">
        <div className="container mx-auto px-4">
          <h3 className="text-2xl font-bold text-center mb-8">Zapatillas de James Harden</h3>
